...
{
    public class SceneObjectSpawnerTests
    {
        ...
        public void A_placement_over_sunken_ground_seats_at_the_water_line()
        {
            ...
            Assert.That(SceneObjectSpawner.SeatHeight(Ground(-2f), sunk), Is.EqualTo(-1.5f),
        ...
        public void A_placement_on_dry_ground_seats_at_terrain_height_plus_its_offset()
        {
            ...
            Assert.That(SceneObjectSpawner.SeatHeight(Ground(3f), standing), Is.EqualTo(3.25f));
        }
    }
}
